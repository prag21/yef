...
class CreativeWriting extends StatefulWidget {
  @override
  _CreativeWritingState createState() => _CreativeWritingState();
}

class _CreativeWritingState extends State<CreativeWriting> {
  bool loggedin = false;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Content Writing Internship'),
        centerTitle: true,
      ),
      ...
      body: ListView(
        children: [
          Padding(
            ...
            child: Text('Content writing work from home internship',
