...
class SociolWork extends StatefulWidget {
  @override
  _SociolWorkState createState() => _SociolWorkState();
}

class _SociolWorkState extends State<SociolWork> {
  bool loggedin = false;
  @override
      ...
      body: ListView(
        children: [
          Padding(
            ...
            child: Text('Social Work, work from home internship',
